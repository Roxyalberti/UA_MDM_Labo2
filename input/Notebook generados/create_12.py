...
SEC_D = {"cell_type": "markdown", "id": "sec_d_md", "metadata": {}, "source": [
    ...
    "```\n\n",
    "El meta-learner aprende **como ponderar** las probabilidades de cada modelo base para cada clase. ",
    "A diferencia del blend fijo (30/45/25), puede aprender pesos **distintos por clase**.\n\n",
...
nb = {
    ...
    "cells": [
        HEADER, SEC_A, SETUP, SEC_B, FE_CODE,
        SEC_C, TRAIN_OOF, SEC_D, META_CODE,
        SEC_E, ROUNDER_CODE, SEC_F, FINAL_COMP
    ]
}

out = pathlib.Path(__file__).parent / '12_Stacking_MetaLearner_Roxy.ipynb'
